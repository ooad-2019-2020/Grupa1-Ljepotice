...
namespace Implementacija.Migrations
{
    ...
    [Migration("20200606204520_MigracijaUplatnica")]
    partial class MigracijaUplatnica
    {
            ...
            modelBuilder.Entity("Implementacija.Models.FormaZaTestDB", b =>
                {
                    ...
                    b.Property<string>("odabranaZona")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Implementacija.Models.FormaZaTretmanDB", b =>
                {
                    ...
                    b.Property<string>("rezultatTretmana")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("tehnikaRada")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("tretman")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Implementacija.Models.RezervacijaDB", b =>
                {
                    ...
                    b.Property<string>("odabraniTretman")
                        .HasColumnType("nvarchar(max)");
